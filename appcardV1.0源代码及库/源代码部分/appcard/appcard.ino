...
#define startBeep() ledcWrite(1, 127)
...
void showgy()
{
    ...
    clk.setTextColor(TFT_WHITE, 0x0000);
    clk.drawString("程序版本:appcard V1.0",1,11);
    clk.pushSprite(0,24);
    clk.deleteSprite();
    clk.unloadFont(); //释放加载字体资源
...
//  tft.fillRect(50,y+30,35,y+36,0x867D);
 ...
 //   tft.drawRect(50,y,35,30,0xFFFF);
    ...
    tft.fillRect(50,y-5,36,6,0x867D);
    tft.fillRect(50,y+24,36,6,0x867D);
...
void loading(byte delayTime)//绘制进度条
{
  ...
  clk.setTextColor(0xFE19, 0x0000); 
  clk.drawRightString("APPCARD V1.0",180,60,2);
